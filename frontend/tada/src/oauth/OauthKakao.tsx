...
function OauthKakao(): JSX.Element {
	...
	// 			},
	// 			body: `grant_type=authorization_code&client_id=${process.env.REACT_APP_API_KEY_KAKAO}&redirect_uri=${process.env.REACT_APP_REDIRECT_URI}kakao&code=${authorizeCode}`,
	// 		})
	// 			.then(res => res.json())
	// 			.then(data => {
